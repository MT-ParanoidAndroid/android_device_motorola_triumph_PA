...
#define MSMFB_DTV_LCDC_ENABLE     _IOW(MSMFB_IOCTL_MAGIC, 163, unsigned int)
#define MSMFB_OVERLAY_REFRESH     _IOW(MSMFB_IOCTL_MAGIC, 164, unsigned int)
//SW2-6-MM-JH-Overlay_played-00+
#define MSMFB_OVERLAY_PLAYED _IOWR(MSMFB_IOCTL_MAGIC, 165, int)
#define MSMFB_MDP_HW_REVISION _IOWR(MSMFB_IOCTL_MAGIC, 166, int)
//SW2-6-MM-JH-Overlay_played-00-
